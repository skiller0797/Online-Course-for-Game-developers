...
<div class="banner banner-inner tc-light brdcrmbs">
   ...
   <div class="row">
                              ...
                              <h1 class="banner-heading">
                                <?php if ( is_archive() ) {
                                 ...
                                 elseif(is_search()){
                                  ...
                                  echo  esc_html__('Search Results For ', 'avadanta-finance') . ' " ' . get_search_query() . ' "';

                                 }elseif ( is_404() ) {
                                  echo  esc_html__('Nothing Found ', 'avadanta-finance');
                                 }
                                 else{
          ...
          <div class="bg-image header-bg-image">
            <img src="<?php echo esc_url(get_header_image()); ?>" alt="<?php echo esc_attr__('banner','avadanta-finance'); ?>">
          </div>
        </div>
