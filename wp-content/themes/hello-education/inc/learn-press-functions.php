 ...
 * Instructor 
 */
add_action( 'learn-press/before-courses-loop-item', 'hello_education_instructor' , 1010 );
if(!function_exists('hello_education_instructor')){
    function hello_education_instructor (){
