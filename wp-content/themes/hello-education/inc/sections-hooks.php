<?php
add_action( 'wp_head', 'hello_education_educenter_remove_course_action' );
function hello_education_educenter_remove_course_action() {
...
if ( ! function_exists( 'hello_education_courses_section' ) ) :
	 ...
	 * @since 1.0.0
	*/
	function hello_education_courses_section() { 

		$courses = get_theme_mod( 'educenter_courses_section_area_options', 0 );
				...
				<div class="container">
					...
					<div class="ed-isotope lp-archive-courses">
						<div class="ed-col-wrap">
							<ul class="learn-press-courses <?php if( $view_style == 'slide') echo 'ed-blog-slider cS-hidden'; ?>" data-layout="<?php echo esc_attr($view_style); ?>" data-items="<?php echo esc_attr($column);?>">
								<?php
...
add_action( 'educenter_courses','hello_education_courses_section', 35 );

if ( ! function_exists( 'hello_education_services_section' ) ) :
	 ...
	 * @since 1.0.0
	*/
	function hello_education_services_section() { 
								...
								<div class="col">
									...
									<div class="text-holder">
										...
										<a href="<?php echo esc_url(get_the_permalink($services_page->ID)); ?>" class="ed-button">
											<?php esc_html_e('read more','hello-education'); ?>
										</a>
...
add_action( 'educenter_services','hello_education_services_section', 25 );

/**
 * Slider Features Services
*/
if ( ! function_exists( 'hello_education_slider_features_services' ) ){
     ...
     * @since 1.0.0
    */
    function hello_education_slider_features_services() { 

        $features_services = get_theme_mod('hello_education_feature_services_area_settings');
...
add_action( 'educenter_action_front_page','hello_education_slider_features_services', 6 );